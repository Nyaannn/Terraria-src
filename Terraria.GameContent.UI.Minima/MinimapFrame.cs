...
public class MinimapFrame : IConfigKeyHolder
{
	...
	public void Update()
	{
		Button i = GetButtonUnderMouse();
		_zoomInButton.IsHighlighted = i == _zoomInButton;
		_zoomOutButton.IsHighlighted = i == _zoomOutButton;
		_resetButton.IsHighlighted = i == _resetButton;
		if (i == null || Main.LocalPlayer.lastMouseInterface)
		{
			return;
		}
