...
public struct PotionOfReturnGateHelper
{
	...
	public void SpawnReturnPortalDust()
	{
		...
		else if (Main.rand.Next(3) == 0)
		{
			if (Main.rand.Next(2) == 0)
			{
				...
				dust3.velocity = vector3.RotatedBy(-0.78539818525314331) * 2f;
			...
			else
			{
				...
				dust4.velocity = vector4.RotatedBy(-0.78539818525314331) * 2f;
	...
	{
		short textValue = (short)((_gateType == GateType.EntryPoint) ? 183 : 184);
		Asset<Texture2D> val = TextureAssets.Extra[textValue];
