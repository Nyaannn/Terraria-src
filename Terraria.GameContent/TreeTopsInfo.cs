...
public class TreeTopsInfo
{
	...
	public void Save(BinaryWriter writer)
	{
		...
		for (int uIElement = 0; uIElement < _variations.Length; uIElement++)
		{
			writer.Write(_variations[uIElement]);
		}
	}
	...
	public void RandomizeTreeStyle(UnifiedRandom rand, int areaId)
	{
		...
		bool idRangeEndExclusive = false;
		while (_variations[areaId] == num)
		{
			...
			case 12:
				...
				break;
			default:
				idRangeEndExclusive = true;
				break;
			}
			if (idRangeEndExclusive)
			{
				break;
			}
		}
