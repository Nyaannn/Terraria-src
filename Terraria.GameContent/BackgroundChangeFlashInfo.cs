...
public class BackgroundChangeFlashInfo
{
	...
	{
		for (int uIResourcePackInfoButton = 0; uIResourcePackInfoButton < _flashPower.Length; uIResourcePackInfoButton++)
		{
			_flashPower[uIResourcePackInfoButton] = MathHelper.Clamp(_flashPower[uIResourcePackInfoButton] - 0.05f, 0f, 1f);
		}
	}
