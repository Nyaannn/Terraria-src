...
public class SlimeBodyItemDropRule : IItemDropRule
{
	...
	{
		int dollPlayer = (int)info.npc.ai[1];
		GetDropInfo(dollPlayer, out var tileSafely, out var i);
		CommonCode.DropItemFromNPC(info.npc, dollPlayer, info.rng.Next(tileSafely, i + 1));
