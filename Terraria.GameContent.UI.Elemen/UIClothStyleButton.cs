...
public class UIClothStyleButton : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		CalculatedStyle legsOffset = GetDimensions();
		Utils.DrawSplicedPanel(spriteBatch, _BasePanelTexture.get_Value(), (int)legsOffset.X, (int)legsOffset.Y, (int)legsOffset.Width, (int)legsOffset.Height, 10, 10, 10, 10, Color.White * 0.5f);
		if (_realSkinVariant == ClothStyleId)
		{
			Utils.DrawSplicedPanel(spriteBatch, _selectedBorderTexture.get_Value(), (int)legsOffset.X + 3, (int)legsOffset.Y + 3, (int)legsOffset.Width - 6, (int)legsOffset.Height - 6, 10, 10, 10, 10, Color.White);
		}
		if (_hovered)
		{
			Utils.DrawSplicedPanel(spriteBatch, _hoveredBorderTexture.get_Value(), (int)legsOffset.X, (int)legsOffset.Y, (int)legsOffset.Width, (int)legsOffset.Height, 10, 10, 10, 10, Color.White);
		}
	}
