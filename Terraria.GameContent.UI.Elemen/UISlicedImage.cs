...
public class UISlicedImage : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		Utils.DrawSplicedPanel(spriteBatch, _texture.get_Value(), (int)num.X, (int)num.Y, (int)num.Width, (int)num.Height, _leftSliceDepth, _rightSliceDepth, _topSliceDepth, _bottomSliceDepth, _color);
	}
