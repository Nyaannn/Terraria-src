...
public class EmoteButton : UIElement
{
	...
	{
		int localShaderIndex = ((_frameCounter >= 10) ? 1 : 0);
		return _texture.Frame(8, EmoteBubble.EMOTE_SHEET_VERTICAL_FRAMES, _emoteIndex % 4 * 2 + localShaderIndex, _emoteIndex / 4 + 1);
	}
