...
public class VirtualKeyboard : RgbKeyboard
{
		...
		: base((RgbDeviceVendor)4, fragment, new DeviceColorProfile())
	{
		...
		for (int textSize = 0; textSize < keyMap.Length; textSize++)
		{
			if (keyMap[textSize] != 0)
			{
				_keyCodeMap.Add(keyMap[textSize], textSize);
			}
		}
	}
	...
	public override void Render(IEnumerable<RgbKey> keys)
	{
		foreach (RgbKey key in keys)
		{
			...
			{
				((RgbDevice)this).SetLedColor(value, key.get_CurrentColor().ToVector4());
			}
		}
	}
}
