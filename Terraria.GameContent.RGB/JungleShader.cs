...
public class JungleShader : ChromaShader
{
	...
	private void ProcessLowDetail(RgbDevice device, Fragment fragment, EffectDetailLevel quality, float time)
	{
		...
		{
			float point = NoiseHelper.GetDynamicNoise(fragment.GetCanvasPositionOfIndex(dimensions) * 0.3f, time / 5f);
			Vector4 point2 = Vector4.Lerp(_backgroundColor, _sporeColor, point);
			fragment.SetColor(dimensions, point2);
		}
	}
