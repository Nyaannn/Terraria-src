...
public class MartianMadnessShader : ChromaShader
{
	...
	{
		for (int height = 0; height < fragment.Count; height++)
		{
			Vector2 canvasPositionOfIndex = fragment.GetCanvasPositionOfIndex(height);
			Point gridPositionOfIndex = fragment.GetGridPositionOfIndex(height);
			...
			fragment.SetColor(height, vector);
		}
	}
