...
public class NetClientSocialModule : NetSocialModule
{
	...
	private void AsyncGetServerIDByOwener(RailID ownerID)
	{
		...
		array.Add(_serverIDMedataKey);
		IRailFriends i = rail_api.RailFactory().RailFriends();
		if (i != null)
		{
			i.AsyncGetFriendMetadata(ownerID, array, "");
		}
	}
	...
	private void CleanMyMetaData()
	{
		...
		IRailFriends flag = rail_api.RailFactory().RailFriends();
		if (flag != null)
		{
			flag.AsyncClearAllMyMetadata("");
		}
	}
