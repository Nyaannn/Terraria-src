...
public static class PlayerDrawLayers
{
	...
	public static void DrawCompositeArmorPiece(ref PlayerDrawSet drawinfo, CompositePlayerDrawContext context, DrawData data)
	{
		...
		case CompositePlayerDrawContext.FrontShoulder:
		{
			...
			DrawData num241 = data;
			num241.color = drawinfo.armGlowColor;
			Rectangle num242 = num241.sourceRect.Value;
			num242.Y += 224;
			num241.sourceRect = num242;
			if (drawinfo.drawPlayer.body == 227)
			{
				Vector2 num243 = num241.position;
				for (int num244 = 0; num244 < 2; num244++)
				{
					Vector2 num245 = new Vector2((float)Main.rand.Next(-10, 10) * 0.125f, (float)Main.rand.Next(-10, 10) * 0.125f);
					num241.position = num243 + num245;
					if (num244 == 0)
					{
						drawinfo.DrawDataCache.Add(num241);
					}
				}
			}
			drawinfo.DrawDataCache.Add(num241);
		...
		if (context == CompositePlayerDrawContext.FrontShoulder && drawinfo.drawPlayer.head == 269)
		{
			...
			DrawData item2 = new DrawData(TextureAssets.Extra[214].get_Value(), position2, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			item2.shader = drawinfo.cHead;
			drawinfo.DrawDataCache.Add(item2);
			item2 = new DrawData(TextureAssets.GlowMask[308].get_Value(), position2, drawinfo.drawPlayer.bodyFrame, drawinfo.headGlowColor, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			item2.shader = drawinfo.cHead;
			drawinfo.DrawDataCache.Add(item2);
		}
		if (context == CompositePlayerDrawContext.FrontArm && drawinfo.drawPlayer.body == 205)
		{
			...
			int num246 = 4;
			for (int j = 0; j < num246; j++)
			{
				float num247 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.2f;
				float num248 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
				DrawData item3 = data;
				Rectangle value2 = item3.sourceRect.Value;
				value2.Y += 224;
				item3.sourceRect = value2;
				item3.position.X += num247;
				item3.position.Y += num248;
				item3.color = color;
	...
	public static void DrawPlayer_01_BackHair(ref PlayerDrawSet drawinfo)
	{
		if (!drawinfo.hideHair && drawinfo.backHairDraw)
		{
			...
			{
				DrawData num240 = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				num240.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(num240);
			}
			else if (drawinfo.hatHair)
			{
				DrawData num240 = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				num240.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(num240);
			}
		}
	...
	public static void DrawPlayer_03_Carpet(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Color num231 = drawinfo.colorArmorLegs;
			float num232 = 0f;
			if (drawinfo.drawPlayer.gravDir == -1f)
			{
				num232 = 10f;
			}
			DrawData num230 = new DrawData(TextureAssets.FlyingCarpet.get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)(drawinfo.drawPlayer.height / 2) + 28f * drawinfo.drawPlayer.gravDir + num232)), new Rectangle(0, TextureAssets.FlyingCarpet.Height() / 6 * drawinfo.drawPlayer.carpetFrame, TextureAssets.FlyingCarpet.Width(), TextureAssets.FlyingCarpet.Height() / 6), num231, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.FlyingCarpet.Width() / 2, TextureAssets.FlyingCarpet.Height() / 8), 1f, drawinfo.playerEffect);
			num230.shader = drawinfo.cCarpet;
			drawinfo.DrawDataCache.Add(num230);
		}
	}
	...
	public static void DrawPlayer_03_PortableStool(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Texture2D num225 = TextureAssets.Extra[102].get_Value();
			Vector2 num226 = new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height + 28f));
			Rectangle num227 = num225.Frame();
			Vector2 num228 = num227.Size() * new Vector2(0.5f, 1f);
			DrawData num224 = new DrawData(num225, num226, num227, drawinfo.colorArmorLegs, drawinfo.drawPlayer.bodyRotation, num228, 1f, drawinfo.playerEffect);
			num224.shader = drawinfo.cPortableStool;
			drawinfo.DrawDataCache.Add(num224);
		}
	}
	...
	public static void DrawPlayer_04_ElectrifiedDebuffBack(ref PlayerDrawSet drawinfo)
	{
		...
		Texture2D num223 = TextureAssets.GlowMask[25].get_Value();
		int num224 = drawinfo.drawPlayer.miscCounter / 5;
		for (int i = 0; i < 2; i++)
		{
			num224 %= 7;
			if (num224 <= 1 || num224 >= 5)
			{
				DrawData num222 = new DrawData(num223, new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2), new Rectangle(0, num224 * num223.Height / 7, num223.Width, num223.Height / 7), drawinfo.colorElectricity, drawinfo.drawPlayer.bodyRotation, new Vector2(num223.Width / 2, num223.Height / 14), 1f, drawinfo.playerEffect);
				drawinfo.DrawDataCache.Add(num222);
			}
			num224 += 3;
		}
	}
	...
	public static void DrawPlayer_05_ForbiddenSetRing(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Color num202 = Color.Lerp(drawinfo.colorArmorBody, Color.White, 0.7f);
			Texture2D type3 = TextureAssets.Extra[74].get_Value();
			Texture2D num203 = TextureAssets.GlowMask[217].get_Value();
			bool num210 = !drawinfo.drawPlayer.setForbiddenCooldownLocked;
			int num204 = 0;
			num204 = (int)(((float)drawinfo.drawPlayer.miscCounter / 300f * ((float)Math.PI * 2f)).ToRotationVector2().Y * 6f);
			float flag4 = ((float)drawinfo.drawPlayer.miscCounter / 75f * ((float)Math.PI * 2f)).ToRotationVector2().X * 4f;
			Color num205 = new Color(80, 70, 40, 0) * (flag4 / 8f + 0.5f) * 0.8f;
			if (!num210)
			{
				num204 = 0;
				flag4 = 2f;
				num205 = new Color(80, 70, 40, 0) * 0.3f;
				num202 = num202.MultiplyRGB(new Color(0.5f, 0.5f, 1f));
			}
			Vector2 num206 = new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2);
			int num207 = 10;
			int num208 = 20;
			...
			num206 += new Vector2(-drawinfo.drawPlayer.direction * num207, (float)(-num208) * drawinfo.drawPlayer.gravDir + (float)num204 * drawinfo.drawPlayer.gravDir);
			DrawData num201 = new DrawData(type3, num206, null, num202, drawinfo.drawPlayer.bodyRotation, type3.Size() / 2f, 1f, drawinfo.playerEffect);
			num201.shader = drawinfo.cBody;
			drawinfo.DrawDataCache.Add(num201);
			for (float num209 = 0f; num209 < 4f; num209 += 1f)
			{
				num201 = new DrawData(num203, num206 + (num209 * ((float)Math.PI / 2f)).ToRotationVector2() * flag4, null, num205, drawinfo.drawPlayer.bodyRotation, type3.Size() / 2f, 1f, drawinfo.playerEffect);
				drawinfo.DrawDataCache.Add(num201);
			}
		}
	}
	...
	public static void DrawPlayer_01_3_BackHead(ref PlayerDrawSet drawinfo)
	{
		...
		{
			int num186 = ArmorIDs.Head.Sets.FrontToBackID[drawinfo.drawPlayer.head];
			if (num186 >= 0)
			{
				Vector2 num187 = drawinfo.helmetOffset;
				DrawData num188 = new DrawData(TextureAssets.ArmorHead[num186].get_Value(), num187 + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				num188.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(num188);
			}
		}
	}
	...
	public static void DrawPlayer_05_2_SafemanSun(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Color num157 = Color.Lerp(drawinfo.colorArmorBody, Color.White, 0.7f);
			Texture2D num158 = TextureAssets.Extra[152].get_Value();
			Texture2D num159 = TextureAssets.Extra[152].get_Value();
			int num160 = 0;
			num160 = (int)(((float)drawinfo.drawPlayer.miscCounter / 300f * ((float)Math.PI * 2f)).ToRotationVector2().Y * 6f);
			float num161 = ((float)drawinfo.drawPlayer.miscCounter / 75f * ((float)Math.PI * 2f)).ToRotationVector2().X * 4f;
			Color color = new Color(80, 70, 40, 0) * (num161 / 8f + 0.5f) * 0.8f;
			Vector2 vector = new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2);
			int num162 = 8;
			int num163 = 20;
			num162 += 4;
			num163 += 4;
			vector += new Vector2(-drawinfo.drawPlayer.direction * num162, (float)(-num163) * drawinfo.drawPlayer.gravDir + (float)num160 * drawinfo.drawPlayer.gravDir);
			DrawData num156 = new DrawData(num158, vector, null, num157, drawinfo.drawPlayer.bodyRotation, num158.Size() / 2f, 1f, drawinfo.playerEffect);
			num156.shader = drawinfo.cHead;
			drawinfo.DrawDataCache.Add(num156);
			for (float num164 = 0f; num164 < 4f; num164 += 1f)
			{
				num156 = new DrawData(num159, vector + (num164 * ((float)Math.PI / 2f)).ToRotationVector2() * num161, null, color, drawinfo.drawPlayer.bodyRotation, num158.Size() / 2f, 1f, drawinfo.playerEffect);
				num156.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(num156);
			}
		}
	...
	public static void DrawPlayer_06_WebbedDebuffBack(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Color num144 = drawinfo.colorArmorBody * 0.75f;
			Texture2D num145 = TextureAssets.Extra[32].get_Value();
			DrawData num143 = new DrawData(num145, new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2), null, num144, drawinfo.drawPlayer.bodyRotation, num145.Size() / 2f, 1f, drawinfo.playerEffect);
			drawinfo.DrawDataCache.Add(num143);
		}
	}
	...
	public static void DrawPlayer_07_LeinforsHairShampoo(ref PlayerDrawSet drawinfo)
	{
		if (drawinfo.drawPlayer.leinforsHair && (drawinfo.fullHair || drawinfo.hatHair || drawinfo.drawsBackHairWithoutHeadgear || drawinfo.drawPlayer.head == -1 || drawinfo.drawPlayer.head == 0) && drawinfo.drawPlayer.hair != 12 && drawinfo.shadow == 0f && Main.rgbToHsl(drawinfo.colorHead).Z > 0.2f)
		{
			...
			{
				Rectangle num138 = Utils.CenteredRectangle(drawinfo.Position + drawinfo.drawPlayer.Size / 2f + new Vector2(0f, drawinfo.drawPlayer.gravDir * -20f), new Vector2(20f, 14f));
				int num139 = Dust.NewDust(num138.TopLeft(), num138.Width, num138.Height, 204, 0f, 0f, 150, default(Color), 0.3f);
				Main.dust[num139].fadeIn = 1f;
				Main.dust[num139].velocity *= 0.1f;
				Main.dust[num139].noLight = true;
				Main.dust[num139].shader = GameShaders.Armor.GetSecondaryShader(drawinfo.drawPlayer.cLeinShampoo, drawinfo.drawPlayer);
				drawinfo.DustCache.Add(num139);
			}
			if (Main.rand.Next(40) == 0 && drawinfo.hatHair)
			{
				Rectangle num140 = Utils.CenteredRectangle(drawinfo.Position + drawinfo.drawPlayer.Size / 2f + new Vector2(drawinfo.drawPlayer.direction * -10, drawinfo.drawPlayer.gravDir * -10f), new Vector2(5f, 5f));
				int num141 = Dust.NewDust(num140.TopLeft(), num140.Width, num140.Height, 204, 0f, 0f, 150, default(Color), 0.3f);
				Main.dust[num141].fadeIn = 1f;
				Main.dust[num141].velocity *= 0.1f;
				Main.dust[num141].noLight = true;
				Main.dust[num141].shader = GameShaders.Armor.GetSecondaryShader(drawinfo.drawPlayer.cLeinShampoo, drawinfo.drawPlayer);
				drawinfo.DustCache.Add(num141);
			}
			if (drawinfo.drawPlayer.velocity.X != 0f && drawinfo.backHairDraw && Main.rand.Next(15) == 0)
			{
				Rectangle r = Utils.CenteredRectangle(drawinfo.Position + drawinfo.drawPlayer.Size / 2f + new Vector2(drawinfo.drawPlayer.direction * -14, 0f), new Vector2(4f, 30f));
				int num142 = Dust.NewDust(r.TopLeft(), r.Width, r.Height, 204, 0f, 0f, 150, default(Color), 0.3f);
				Main.dust[num142].fadeIn = 1f;
				Main.dust[num142].velocity *= 0.1f;
				Main.dust[num142].noLight = true;
				Main.dust[num142].shader = GameShaders.Armor.GetSecondaryShader(drawinfo.drawPlayer.cLeinShampoo, drawinfo.drawPlayer);
				drawinfo.DustCache.Add(num142);
			}
		}
	}
	...
	public static void DrawPlayer_08_Backpacks(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Vector2 num58 = new Vector2(-2f + -2f * drawinfo.drawPlayer.Directions.X, 0f) + drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2);
			num58 = num58.Floor();
			Texture2D num59 = TextureAssets.Extra[212].get_Value();
			Rectangle num60 = num59.Frame(1, 5, 0, drawinfo.drawPlayer.miscCounter % 25 / 5);
			Color num61 = drawinfo.drawPlayer.GetImmuneAlphaPure(new Color(250, 250, 250, 200), drawinfo.shadow);
			num61 *= drawinfo.drawPlayer.stealth;
			DrawData num57 = new DrawData(num59, num58, num60, num61, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			num57.shader = drawinfo.cBody;
			drawinfo.DrawDataCache.Add(num57);
		}
		if (DrawPlayer_08_PlayerVisuallyHasFullArmorSet(drawinfo, 268, 237, 222))
		{
			Vector2 maxValue = new Vector2(-9f + 1f * drawinfo.drawPlayer.Directions.X, -4f * drawinfo.drawPlayer.Directions.Y) + drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2);
			maxValue = maxValue.Floor();
			Texture2D num62 = TextureAssets.Extra[213].get_Value();
			Rectangle num63 = num62.Frame(1, 5, 0, drawinfo.drawPlayer.miscCounter % 25 / 5);
			Color num64 = drawinfo.drawPlayer.GetImmuneAlphaPure(new Color(250, 250, 250, 200), drawinfo.shadow);
			num64 *= drawinfo.drawPlayer.stealth;
			DrawData num57 = new DrawData(num62, maxValue, num63, num64, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			num57.shader = drawinfo.cBody;
			drawinfo.DrawDataCache.Add(num57);
		}
		...
		{
			int tile2 = 8;
			Vector2 num65 = new Vector2(0f, 8f);
			Vector2 num66 = drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + num65;
			num66 = num66.Floor();
			DrawData num57 = new DrawData(TextureAssets.BackPack[tile2].get_Value(), num66, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			drawinfo.DrawDataCache.Add(num57);
		}
		if (drawinfo.drawPlayer.backpack > 0 && drawinfo.drawPlayer.backpack < ArmorIDs.Back.Count && !drawinfo.drawPlayer.mount.Active)
		{
			Vector2 num67 = new Vector2(0f, 8f);
			Vector2 num68 = drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + num67;
			num68 = num68.Floor();
			DrawData num57 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.backpack].get_Value(), num68, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			num57.shader = drawinfo.cBackpack;
			drawinfo.DrawDataCache.Add(num57);
		}
		else
		{
			...
			int num69 = drawinfo.heldItem.type;
			int num70 = 1;
			float num71 = -4f;
			float num72 = -8f;
			int num73 = 0;
			...
			Vector2 num74 = new Vector2(0f, 8f);
			Vector2 num75 = drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + num74;
			num75 = num75.Floor();
			Vector2 num76 = drawinfo.Position - Main.screenPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2((-9f + num71) * (float)drawinfo.drawPlayer.direction, (2f + num72) * drawinfo.drawPlayer.gravDir) + num74;
			num76 = num76.Floor();
			switch (num70)
			{
			case 7:
			{
				DrawData num57 = new DrawData(TextureAssets.BackPack[num70].get_Value(), num75, new Rectangle(0, drawinfo.drawPlayer.bodyFrame.Y, TextureAssets.BackPack[num70].Width(), drawinfo.drawPlayer.bodyFrame.Height), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2((float)TextureAssets.BackPack[num70].Width() * 0.5f, drawinfo.bodyVect.Y), 1f, drawinfo.playerEffect);
				num57.shader = num73;
				drawinfo.DrawDataCache.Add(num57);
				break;
			}
			...
			case 6:
			{
				DrawData num57 = new DrawData(TextureAssets.BackPack[num70].get_Value(), num75, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
				num57.shader = num73;
				drawinfo.DrawDataCache.Add(num57);
				break;
			}
			default:
			{
				DrawData num57 = new DrawData(TextureAssets.BackPack[num70].get_Value(), num76, new Rectangle(0, 0, TextureAssets.BackPack[num70].Width(), TextureAssets.BackPack[num70].Height()), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.BackPack[num70].Width() / 2, TextureAssets.BackPack[num70].Height() / 2), 1f, drawinfo.playerEffect);
				num57.shader = num73;
				drawinfo.DrawDataCache.Add(num57);
				break;
			}
	...
	public static void DrawPlayer_08_1_Tails(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Vector2 num51 = Vector2.Zero;
			if (drawinfo.isSitting)
			{
				num51.Y += -2f;
			}
			Vector2 num52 = new Vector2(0f, 8f);
			Vector2 num53 = num51 + drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + num52;
			num53 = num53.Floor();
			DrawData num54 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.tail].get_Value(), num53, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			num54.shader = drawinfo.cTail;
			drawinfo.DrawDataCache.Add(num54);
		}
	}
	...
	public static void DrawPlayer_10_BackAcc(ref PlayerDrawSet drawinfo)
	{
		...
		{
			int point = drawinfo.drawPlayer.bodyFrame.Y / 56;
			if (point < 1 || point > 5)
			{
		...
		Vector2 num29 = new Vector2(0f, 8f);
		Vector2 num24 = zero + drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + num29;
		num24 = num24.Floor();
		DrawData num23 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.back].get_Value(), num24, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
		num23.shader = drawinfo.cBack;
		drawinfo.DrawDataCache.Add(num23);
		if (drawinfo.drawPlayer.back == 36)
		{
			Rectangle num25 = drawinfo.drawPlayer.bodyFrame;
			Rectangle num26 = num25;
			num26.Width = 2;
			int num27 = 0;
			int num28 = num25.Width / 2;
			int num30 = 2;
			...
			for (int i = 0; i < num28; i++)
			{
				...
				num23 = new DrawData(TextureAssets.GlowMask[332].get_Value(), num24 + new Vector2(num27 + i * num30, 0f), num26, immuneAlpha, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
				num23.shader = drawinfo.cBack;
				drawinfo.DrawDataCache.Add(num23);
			}
		}
	...
	public static void DrawPlayer_09_Wings(ref PlayerDrawSet drawinfo)
	{
		...
		Vector2 num19 = drawinfo.drawPlayer.Directions;
		Vector2 num20 = drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.Size / 2f;
		Vector2 num21 = new Vector2(0f, 7f);
		num20 = drawinfo.Position - Main.screenPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + num21;
		if (drawinfo.drawPlayer.wings <= 0)
		{
			return;
		}
		Main.instance.LoadWings(drawinfo.drawPlayer.wings);
		DrawData treeTileType;
		if (drawinfo.drawPlayer.wings == 22)
		{
			...
			Color num22 = drawinfo.colorArmorBody;
			int num23 = 26;
			int num24 = -9;
			Vector2 vector = num20 + new Vector2(num24, num23) * num19;
			if (drawinfo.shadow == 0f && drawinfo.drawPlayer.grappling[0] == -1)
			{
				for (int i = 0; i < 7; i++)
				{
					...
					vector2.X = drawinfo.drawPlayer.itemFlamePos[i].X;
					vector2.Y = 0f - drawinfo.drawPlayer.itemFlamePos[i].Y;
					vector2 *= 0.5f;
					Vector2 position = (vector + vector2).Floor();
					treeTileType = new DrawData(TextureAssets.ItemFlame[1866].get_Value(), position, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7 - 2), color, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 14), 1f, drawinfo.playerEffect);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
			treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].get_Value(), vector.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7), num22, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 14), 1f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
			return;
		}
		if (drawinfo.drawPlayer.wings == 28)
		{
			if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
			{
				...
				Vector2 vector3 = new Vector2(0f, 19f);
				Vector2 vec = num20 + vector3 * num19;
				...
				rectangle.Width -= 2;
				rectangle.Height -= 2;
				treeTileType = new DrawData(value, vec.Floor(), rectangle, Color.Lerp(colorArmorBody, Color.White, 1f), drawinfo.drawPlayer.bodyRotation, rectangle.Size() / 2f, 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
				value = TextureAssets.Extra[38].get_Value();
				treeTileType = new DrawData(value, vec.Floor(), rectangle, Color.Lerp(colorArmorBody, Color.White, 0.5f), drawinfo.drawPlayer.bodyRotation, rectangle.Size() / 2f, 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
			return;
		...
		if (drawinfo.drawPlayer.wings == 45)
		{
			...
			DrawStarboardRainbowTrail(ref drawinfo, num20, num19);
			Color color2 = new Color(255, 255, 255, 255);
			int num25 = 22;
			int num26 = 0;
			Vector2 vec2 = num20 + new Vector2(num26, num25) * num19;
			...
			{
				float num27 = ((float)drawinfo.drawPlayer.miscCounter / 75f * ((float)Math.PI * 2f)).ToRotationVector2().X * 4f;
				Color color4 = new Color(70, 70, 70, 0) * (num27 / 8f + 0.5f) * 0.4f;
				for (float num28 = 0f; num28 < (float)Math.PI * 2f; num28 += (float)Math.PI / 2f)
				{
					treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].get_Value(), vec2.Floor() + num28.ToRotationVector2() * num27, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 6 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 6), color4, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 12), 1f, drawinfo.playerEffect);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
		...
		if (drawinfo.drawPlayer.wings == 34)
		{
			if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
			{
				...
				Vector2 vec3 = drawinfo.Position + drawinfo.drawPlayer.Size / 2f - Main.screenPosition + vector4 * drawinfo.drawPlayer.Directions - Vector2.UnitX * drawinfo.drawPlayer.direction * 4f;
				Rectangle rectangle2 = value2.Frame(1, 6, 0, drawinfo.drawPlayer.wingFrame);
				rectangle2.Width -= 2;
				rectangle2.Height -= 2;
				treeTileType = new DrawData(value2, vec3.Floor(), rectangle2, color5, drawinfo.drawPlayer.bodyRotation, rectangle2.Size() / 2f, 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
			return;
		...
		if (drawinfo.drawPlayer.wings == 40)
		{
			...
			for (int j = 0; j < 1; j++)
			{
				...
				Vector2 vector7 = drawinfo.drawPlayer.velocity * -1.5f;
				int num29 = 0;
				int num30 = 8;
				float num31 = 4f;
				...
				{
					Vector2 vec4 = vector6;
					Rectangle rectangle3 = value3.Frame(1, 14, 0, k);
					rectangle3.Width -= 2;
					rectangle3.Height -= 2;
					int num32 = (k - num29) % (int)num31;
					Vector2 vector8 = new Vector2(0f, 0.5f).RotatedBy((drawinfo.drawPlayer.miscCounterNormalized * (2f + (float)num32) + (float)num32 * 0.5f + (float)j * 1.3f) * ((float)Math.PI * 2f)) * (num32 + 1);
					vec4 += vector8;
					vec4 += vector7 * ((float)num32 / num31);
					vec4 += zero;
					treeTileType = new DrawData(value3, vec4.Floor(), rectangle3, color6, drawinfo.drawPlayer.bodyRotation, rectangle3.Size() / 2f, scale, spriteEffects);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
		...
		if (drawinfo.drawPlayer.wings == 39)
		{
			if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
			{
				...
				Vector2 vector9 = new Vector2(-6f, -7f);
				Texture2D value4 = TextureAssets.Wings[drawinfo.drawPlayer.wings].get_Value();
				Vector2 vec5 = num20 + vector9 * num19;
				Rectangle rectangle4 = value4.Frame(1, 6, 0, drawinfo.drawPlayer.wingFrame);
				rectangle4.Width -= 2;
				rectangle4.Height -= 2;
				treeTileType = new DrawData(value4, vec5.Floor(), rectangle4, colorArmorBody2, drawinfo.drawPlayer.bodyRotation, rectangle4.Size() / 2f, 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
			return;
		...
		Vector2 vector10 = num20 + new Vector2(num34 - 9, num33 + 2) * num19;
		treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].get_Value(), vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35), color7, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35 / 2), 1f, drawinfo.playerEffect);
		treeTileType.shader = drawinfo.cWings;
		drawinfo.DrawDataCache.Add(treeTileType);
		if (drawinfo.drawPlayer.wings == 43 && drawinfo.shadow == 0f)
		{
			Vector2 vector11 = vector10;
			Vector2 origin = new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35 / 2);
			Rectangle value5 = new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num35);
			for (int l = 0; l < 2; l++)
			{
				treeTileType = new DrawData(position: vector11 + new Vector2((float)Main.rand.Next(-10, 10) * 0.125f, (float)Main.rand.Next(-10, 10) * 0.125f), texture: TextureAssets.GlowMask[272].get_Value(), sourceRect: value5, color: new Color(230, 230, 230, 60), rotation: drawinfo.drawPlayer.bodyRotation, origin: origin, scale: 1f, effect: drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		}
		...
		else if (drawinfo.drawPlayer.wings == 44)
		{
			...
			if (playerRainbowWings.IsReady)
			{
				...
				treeTileType = new DrawData(target, vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 7), new Color(255, 255, 255, 255) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 14), 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		}
		...
		{
			treeTileType = new DrawData(TextureAssets.GlowMask[181].get_Value(), vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 127) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
		}
		else if (drawinfo.drawPlayer.wings == 38)
		{
			...
			treeTileType = new DrawData(TextureAssets.GlowMask[251].get_Value(), vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color9, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
			for (int num36 = drawinfo.drawPlayer.shadowPos.Length - 2; num36 >= 0; num36--)
			{
				Color color10 = color9;
				color10.A = 0;
				color10 *= MathHelper.Lerp(1f, 0f, (float)num36 / 3f);
				color10 *= 0.1f;
				Vector2 vector12 = drawinfo.drawPlayer.shadowPos[num36] - drawinfo.drawPlayer.position;
				for (float num37 = 0f; num37 < 1f; num37 += 0.01f)
				{
					Vector2 vector13 = new Vector2(2f, 0f).RotatedBy(num37 / 0.04f * ((float)Math.PI * 2f));
					treeTileType = new DrawData(TextureAssets.GlowMask[251].get_Value(), vector13 + vector12 * num37 + vector10, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color10 * (1f - num37), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
		...
		{
			treeTileType = new DrawData(TextureAssets.GlowMask[213].get_Value(), vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 0) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1.06f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
			Vector2 spinningpoint = new Vector2(0f, 2f - drawinfo.shadow * 2f);
			for (int m = 0; m < 4; m++)
			{
				treeTileType = new DrawData(TextureAssets.GlowMask[213].get_Value(), spinningpoint.RotatedBy((float)Math.PI / 2f * (float)m) + vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(127, 127, 127, 127) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		}
		else if (drawinfo.drawPlayer.wings == 31)
		{
			...
			for (int n = 0; n < 4; n++)
			{
				Vector2 vector14 = new Vector2((float)Math.Cos((float)Math.PI * 2f * ((float)drawinfo.drawPlayer.miscCounter / 60f)) * 0.5f + 0.5f, 0f).RotatedBy((float)n * ((float)Math.PI / 2f)) * 1f;
				treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].get_Value(), vector10.Floor() + vector14, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color11 * drawinfo.stealth * (1f - drawinfo.shadow) * 0.5f, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		...
		{
			treeTileType = new DrawData(TextureAssets.GlowMask[183].get_Value(), vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 0) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1.06f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
		}
	}
	...
	public static void DrawPlayer_12_1_BalloonFronts(ref PlayerDrawSet drawinfo)
	{
		...
		{
			list = new DrawData(TextureAssets.AccBalloon[drawinfo.drawPlayer.balloonFront].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + drawinfo.bodyVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			list.shader = drawinfo.cBalloonFront;
			drawinfo.DrawDataCache.Add(list);
			return;
		}
		int num16 = ((Main.hasFocus && (!Main.ingameOptionsWindow || !Main.autoPause)) ? (DateTime.Now.Millisecond % 800 / 200) : 0);
		Vector2 num17 = Main.OffsetsPlayerOffhand[drawinfo.drawPlayer.bodyFrame.Y / 56];
		if (drawinfo.drawPlayer.direction != 1)
		{
			num17.X = (float)drawinfo.drawPlayer.width - num17.X;
		}
		if (drawinfo.drawPlayer.gravDir != 1f)
		{
			num17.Y -= drawinfo.drawPlayer.height;
		}
		Vector2 value = new Vector2(0f, 8f) + new Vector2(0f, 6f);
		Vector2 num18 = new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X + num17.X), (int)(drawinfo.Position.Y - Main.screenPosition.Y + num17.Y * drawinfo.drawPlayer.gravDir));
		num18 = drawinfo.Position - Main.screenPosition + num17 * new Vector2(1f, drawinfo.drawPlayer.gravDir) + new Vector2(0f, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height) + value;
		num18 = num18.Floor();
		list = new DrawData(TextureAssets.AccBalloon[drawinfo.drawPlayer.balloonFront].get_Value(), num18, new Rectangle(0, TextureAssets.AccBalloon[drawinfo.drawPlayer.balloonFront].Height() / 4 * num16, TextureAssets.AccBalloon[drawinfo.drawPlayer.balloonFront].Width(), TextureAssets.AccBalloon[drawinfo.drawPlayer.balloonFront].Height() / 4), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(26 + drawinfo.drawPlayer.direction * 4, 28f + drawinfo.drawPlayer.gravDir * 6f), 1f, drawinfo.playerEffect);
		list.shader = drawinfo.cBalloonFront;
		drawinfo.DrawDataCache.Add(list);
	}
	...
	public static void DrawPlayer_11_Balloons(ref PlayerDrawSet drawinfo)
	{
		...
		{
			i = new DrawData(TextureAssets.AccBalloon[drawinfo.drawPlayer.balloon].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + drawinfo.bodyVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			i.shader = drawinfo.cBalloon;
			drawinfo.DrawDataCache.Add(i);
			return;
		}
		int j = ((Main.hasFocus && (!Main.ingameOptionsWindow || !Main.autoPause)) ? (DateTime.Now.Millisecond % 800 / 200) : 0);
		Vector2 num = Main.OffsetsPlayerOffhand[drawinfo.drawPlayer.bodyFrame.Y / 56];
		if (drawinfo.drawPlayer.direction != 1)
		{
			num.X = (float)drawinfo.drawPlayer.width - num.X;
		}
		if (drawinfo.drawPlayer.gravDir != 1f)
		{
			num.Y -= drawinfo.drawPlayer.height;
		}
		Vector2 num2 = new Vector2(0f, 8f) + new Vector2(0f, 6f);
		Vector2 k = new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X + num.X), (int)(drawinfo.Position.Y - Main.screenPosition.Y + num.Y * drawinfo.drawPlayer.gravDir));
		k = drawinfo.Position - Main.screenPosition + num * new Vector2(1f, drawinfo.drawPlayer.gravDir) + new Vector2(0f, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height) + num2;
		k = k.Floor();
		i = new DrawData(TextureAssets.AccBalloon[drawinfo.drawPlayer.balloon].get_Value(), k, new Rectangle(0, TextureAssets.AccBalloon[drawinfo.drawPlayer.balloon].Height() / 4 * j, TextureAssets.AccBalloon[drawinfo.drawPlayer.balloon].Width(), TextureAssets.AccBalloon[drawinfo.drawPlayer.balloon].Height() / 4), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(26 + drawinfo.drawPlayer.direction * 4, 28f + drawinfo.drawPlayer.gravDir * 6f), 1f, drawinfo.playerEffect);
		i.shader = drawinfo.cBalloon;
		drawinfo.DrawDataCache.Add(i);
	}
	...
	private static void DrawSittingLongCoats(ref PlayerDrawSet drawinfo, int specialLegCoat, Texture2D textureToDraw, Color matchingColor, int shaderIndex = 0, bool glowmask = false)
	{
		...
		DrawData i = new DrawData(textureToDraw, position, legFrame, matchingColor, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect);
		i.shader = shaderIndex;
		drawinfo.DrawDataCache.Add(i);
	}
	...
	private static void DrawSittingLegs(ref PlayerDrawSet drawinfo, Texture2D textureToDraw, Color matchingColor, int shaderIndex = 0, bool glowmask = false)
	{
		...
		for (int num8 = num3; num8 >= 0; num8--)
		{
			...
			position.Y += num2;
			position.Y += num5;
			DrawData tile = new DrawData(textureToDraw, position, value, matchingColor, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect);
			tile.shader = shaderIndex;
			drawinfo.DrawDataCache.Add(tile);
		}
	}
	...
	public static void DrawPlayer_14_Shoes(ref PlayerDrawSet drawinfo)
	{
		...
		if (drawinfo.isSitting)
		{
			DrawSittingLegs(ref drawinfo, TextureAssets.AccShoes[drawinfo.drawPlayer.shoe].get_Value(), drawinfo.colorArmorLegs, num);
			return;
		}
		DrawData i = new DrawData(TextureAssets.AccShoes[drawinfo.drawPlayer.shoe].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.legFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.legFrame.Height + 4f)) + drawinfo.drawPlayer.legPosition + drawinfo.legVect, drawinfo.drawPlayer.legFrame, drawinfo.colorArmorLegs, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect);
		i.shader = num;
		drawinfo.DrawDataCache.Add(i);
	...
	public static void DrawPlayer_27_HeldItem(ref PlayerDrawSet drawinfo)
	{
		...
		case 3779:
		{
			...
			{
				item = new DrawData(TextureAssets.GlowMask[218].get_Value(), (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor() + (num8 * ((float)Math.PI / 2f)).ToRotationVector2() * num7, rectangle3, color2, drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect);
				drawinfo.DrawDataCache.Add(item);
			}
	...
	public static void DrawPlayer_29_OnhandAcc(ref PlayerDrawSet drawinfo)
	{
		...
		{
			DrawData paintIDForPosition = new DrawData(TextureAssets.AccHandsOn[drawinfo.drawPlayer.handon].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2), drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			paintIDForPosition.shader = drawinfo.cHandOn;
			drawinfo.DrawDataCache.Add(paintIDForPosition);
		}
	}
	...
	{
		List<DrawData> i = drawinfo.DrawDataCache;
		...
		{
			if (drawinfo.projectileDrawPosition == j)
			{
				if (cdd.shader != 0)
				{
