...
public class NetBestiaryModule : NetModule
{
	...
	{
		NetPacket innerDimensions = NetModule.CreatePacket<NetBestiaryModule>(5);
		innerDimensions.Writer.Write((byte)0);
		innerDimensions.Writer.Write((short)npcNetId);
		innerDimensions.Writer.Write((ushort)killcount);
