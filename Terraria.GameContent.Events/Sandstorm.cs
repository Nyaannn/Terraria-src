...
public class Sandstorm
{
	...
	public static void HandleEffectAndSky(bool toState)
	{
		...
		{
			_effectsUp = toState;
			Vector2 i = Main.player[Main.myPlayer].Center;
			if (_effectsUp)
			{
				SkyManager.Instance.Activate("Sandstorm", i);
				Filters.Scene.Activate("Sandstorm", i);
				Overlays.Scene.Activate("Sandstorm", i);
			}
			else
			{
