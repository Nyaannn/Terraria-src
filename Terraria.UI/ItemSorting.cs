...
public class ItemSorting
{
	...
	public static void SetupWhiteLists()
	{
		...
		List<ItemSortingLayer> ex = new List<ItemSortingLayer>();
		List<Item> list = new List<Item>();
		List<int> list2 = new List<int>();
		ex.Add(ItemSortingLayers.WeaponsMelee);
		ex.Add(ItemSortingLayers.WeaponsRanged);
		ex.Add(ItemSortingLayers.WeaponsMagic);
		ex.Add(ItemSortingLayers.WeaponsMinions);
		ex.Add(ItemSortingLayers.WeaponsAssorted);
		ex.Add(ItemSortingLayers.WeaponsAmmo);
		ex.Add(ItemSortingLayers.ToolsPicksaws);
		ex.Add(ItemSortingLayers.ToolsHamaxes);
		ex.Add(ItemSortingLayers.ToolsPickaxes);
		ex.Add(ItemSortingLayers.ToolsAxes);
		ex.Add(ItemSortingLayers.ToolsHammers);
		ex.Add(ItemSortingLayers.ToolsTerraforming);
		ex.Add(ItemSortingLayers.ToolsAmmoLeftovers);
		ex.Add(ItemSortingLayers.ArmorCombat);
		ex.Add(ItemSortingLayers.ArmorVanity);
		ex.Add(ItemSortingLayers.ArmorAccessories);
		ex.Add(ItemSortingLayers.EquipGrapple);
		ex.Add(ItemSortingLayers.EquipMount);
		ex.Add(ItemSortingLayers.EquipCart);
		ex.Add(ItemSortingLayers.EquipLightPet);
		ex.Add(ItemSortingLayers.EquipVanityPet);
		ex.Add(ItemSortingLayers.PotionsDyes);
		ex.Add(ItemSortingLayers.PotionsHairDyes);
		ex.Add(ItemSortingLayers.PotionsLife);
		ex.Add(ItemSortingLayers.PotionsMana);
		ex.Add(ItemSortingLayers.PotionsElixirs);
		ex.Add(ItemSortingLayers.PotionsBuffs);
		ex.Add(ItemSortingLayers.MiscValuables);
		ex.Add(ItemSortingLayers.MiscPainting);
		ex.Add(ItemSortingLayers.MiscWiring);
		ex.Add(ItemSortingLayers.MiscMaterials);
		ex.Add(ItemSortingLayers.MiscRopes);
		ex.Add(ItemSortingLayers.MiscExtractinator);
		ex.Add(ItemSortingLayers.LastMaterials);
		ex.Add(ItemSortingLayers.LastTilesImportant);
		ex.Add(ItemSortingLayers.LastTilesCommon);
		ex.Add(ItemSortingLayers.LastNotTrash);
		ex.Add(ItemSortingLayers.LastTrash);
		...
		Item[] array = list.ToArray();
		foreach (ItemSortingLayer item2 in ex)
		{
			List<int> list3 = item2.SortingMethod(item2, array, list2);
			List<int> list4 = new List<int>();
			for (int j = 0; j < list3.Count; j++)
			{
				list4.Add(array[list3[j]].netID);
			}
			_layerWhiteLists.Add(item2.Name, list4);
		}
	}
