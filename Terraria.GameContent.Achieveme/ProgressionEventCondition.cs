...
public class ProgressionEventCondition : AchievementCondition
{
	...
	{
		ProgressionEventCondition[] uIAchievementListItem = new ProgressionEventCondition[eventIDs.Length];
		for (int i = 0; i < eventIDs.Length; i++)
		{
			uIAchievementListItem[i] = new ProgressionEventCondition(eventIDs[i]);
		}
