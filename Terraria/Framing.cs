...
public class Framing
{
	...
	public static Tile GetTileSafely(int i, int j)
	{
		...
		Tile originalScreenSize = Main.tile[i, j];
		if (originalScreenSize == null)
		{
			originalScreenSize = new Tile();
			Main.tile[i, j] = originalScreenSize;
		}
