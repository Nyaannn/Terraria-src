...
public static class Actions
{
	...
	public class TileScanner : GenAction
	{
		...
		public TileScanner Output(Dictionary<ushort, int> resultsOutput)
		{
			...
			for (int uIAchievementListItem = 0; uIAchievementListItem < _tileIds.Length; uIAchievementListItem++)
			{
				if (!_tileCounts.ContainsKey(_tileIds[uIAchievementListItem]))
				{
					_tileCounts[_tileIds[uIAchievementListItem]] = 0;
				}
			}
			return this;
		}
