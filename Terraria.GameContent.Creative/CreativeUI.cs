...
public class CreativeUI
{
	...
	{
		Vector2 i = _buttonTexture.Size();
		Rectangle canvasPositionOfIndex = Utils.CenteredRectangle(location + i / 2f, i);
		UILinkPointNavigator.SetPosition(311, canvasPositionOfIndex.Center.ToVector2());
		...
		if (canvasPositionOfIndex.Contains(Main.MouseScreen.ToPoint()))
		{
