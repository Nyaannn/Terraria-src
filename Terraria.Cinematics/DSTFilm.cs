...
public class DSTFilm : Film
{
	...
	private void EquipDSTShaderItem(FrameEventData evt)
	{
		...
		Item num = new Item();
		num.SetDefaults(5113);
		Main.LocalPlayer.armor[3] = num;
	}
	...
	private void ControlPlayer(FrameEventData evt)
	{
		...
		FindFloorAt(_startPoint + new Vector2(150f, 0f), out var scale, out var y);
		localPlayer.BottomLeft = new Vector2(scale, y);
