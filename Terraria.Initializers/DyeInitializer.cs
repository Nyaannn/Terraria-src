...
public static class DyeInitializer
{
	...
	{
		Ref<Effect> playerPathFromName = Main.PixelShaderRef;
		LoadLegacyHairdyes();
		GameShaders.Hair.BindShader(3259, new TwilightHairDyeShaderData(playerPathFromName, "ArmorTwilight")).UseImage("Images/Misc/noise").UseColor(0.5f, 0.1f, 1f);
	}
	...
	{
		Ref<Effect> value = Main.PixelShaderRef;
		GameShaders.Misc["ForceField"] = new MiscShaderData(value, "ForceField");
		GameShaders.Misc["WaterProcessor"] = new MiscShaderData(value, "WaterProcessor");
		GameShaders.Misc["WaterDistortionObject"] = new MiscShaderData(value, "WaterDistortionObject");
		GameShaders.Misc["WaterDebugDraw"] = new MiscShaderData(Main.ScreenShaderRef, "WaterDebugDraw");
		GameShaders.Misc["HallowBoss"] = new MiscShaderData(value, "HallowBoss");
		GameShaders.Misc["HallowBoss"].UseImage1("Images/Extra_" + (short)156);
		GameShaders.Misc["MaskedFade"] = new MiscShaderData(value, "MaskedFade");
		GameShaders.Misc["MaskedFade"].UseImage1("Images/Extra_" + (short)216);
		GameShaders.Misc["QueenSlime"] = new MiscShaderData(value, "QueenSlime");
		...
		GameShaders.Misc["StardewValleyFade"] = new MiscShaderData(value, "MaskedFade").UseSamplerState(SamplerState.LinearClamp);
		GameShaders.Misc["StardewValleyFade"].UseImage1("Images/Extra_" + (short)248);
		GameShaders.Misc["RainbowTownSlime"] = new MiscShaderData(value, "RainbowTownSlime");
		int type = 3530;
	...
	{
		Ref<Effect> flag = Main.VertexPixelShaderRef;
		GameShaders.Misc["MagicMissile"] = new MiscShaderData(flag, "MagicMissile").UseProjectionMatrix(doUse: true);
		...
		GameShaders.Misc["FlameLash"] = new MiscShaderData(flag, "MagicMissile").UseProjectionMatrix(doUse: true);
		...
		GameShaders.Misc["RainbowRod"] = new MiscShaderData(flag, "MagicMissile").UseProjectionMatrix(doUse: true);
		...
		GameShaders.Misc["FinalFractal"] = new MiscShaderData(flag, "FinalFractalVertex").UseProjectionMatrix(doUse: true);
		...
		GameShaders.Misc["EmpressBlade"] = new MiscShaderData(flag, "FinalFractalVertex").UseProjectionMatrix(doUse: true);
		...
		GameShaders.Misc["LightDisc"] = new MiscShaderData(flag, "MagicMissile").UseProjectionMatrix(doUse: true);
