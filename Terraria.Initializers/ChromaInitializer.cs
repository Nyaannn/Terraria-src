...
public static class ChromaInitializer
{
	...
	private static void AddDevices()
	{
		...
		_engine.set_FrameTimeInSeconds(1f / _rgbUpdateRate);
		if (_useRazer)
		{
	...
	{
		Bind_Event properties = new Bind_Event("TERRARIA", eventName, 0, 10, EventIconId.Default, new AbstractHandler[1]
		{
