...
public static class PlayerDataInitializer
{
	...
	{
		for (int text = 0; text < pieceIDs.Length; text++)
		{
			TextureAssets.Players[ID, pieceIDs[text]] = Main.Assets.Request<Texture2D>("Images/Player_" + ID + "_" + pieceIDs[text], (AssetRequestMode)2);
		}
	}
