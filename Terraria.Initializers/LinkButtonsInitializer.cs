...
public class LinkButtonsInitializer
{
	...
	{
		Asset<Texture2D> num = Main.Assets.Request<Texture2D>("Images/UI/TitleLinkButtons", (AssetRequestMode)1);
		Rectangle array = num.Frame(7, 2, horizontalFrameIndex);
		Rectangle num2 = num.Frame(7, 2, horizontalFrameIndex, 1);
		array.Width--;
		array.Height--;
		num2.Width--;
		num2.Height--;
		return new TitleLinkButton
		{
			...
			LinkUrl = linkUrl,
			FrameWehnSelected = num2,
			FrameWhenNotSelected = array,
			Image = num
		};
	}
}
