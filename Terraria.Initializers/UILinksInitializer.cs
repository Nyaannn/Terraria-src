...
public class UILinksInitializer
{
	...
	{
		if (Main.MenuUI.CurrentState is UICharacterCreation b)
		{
			b.TryMovingCategory(direction);
		}
		if (UserInterface.ActiveInstance.CurrentState is UIBestiaryTest fileType)
		{
			fileType.TryMovingPages(direction);
		}
	}
